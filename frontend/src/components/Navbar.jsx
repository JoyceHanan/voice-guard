      ...
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="font-bold text-body-strong tracking-wider text-[#201d1d]">[voiceguard // enterprise]</span>
        ...
        <div className="flex items-center bg-[#f8f7f7] p-1 rounded-[4px] border border-[rgba(15,0,0,0.12)]">
          <button
            ...
            className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-[4px] text-caption-md font-mono transition-colors ${
              activeTab === 'dashboard'
